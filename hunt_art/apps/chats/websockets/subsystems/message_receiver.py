...
class ChatMessageReceiver:
    ...
    def __init__(self, subsystem_name: str, consumer: AsyncJsonWebsocketConsumer) -> None:
        self.subsystem_name = subsystem_name
        self.consumer = consumer

    async def receive(self, content: dict[str, Any]) -> None:
        """
    ...
    async def _send_to_user(self, content: dict[str, Any]) -> None:
        ...
        other_user: User = await User.objects.filter(pk=data['user_id']).aget()
